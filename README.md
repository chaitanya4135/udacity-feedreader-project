# download the zip project and check using the chrome
...
The following are the steps for the feed reader


# Feed Reader Project

This project mainly focuses on testing 'javascript' code using Jasmine.
...
* turn on the server like  `200 OK!` and copy the link.
...
* The menu
    ...
    * By clicking on menu button it should open and close .
...
* up to now i know how to design a project.

* after completing this project i learned how to test a project.
